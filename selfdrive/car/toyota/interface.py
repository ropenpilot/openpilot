...
>>>>>>> Delete toyota tuning
      ...
      # TODO override until there is enough data
      if candidate == CAR.AVALON:
        torque_params = CarInterfaceBase.get_torque_params(CAR.AVALON_2019)
      ...
      # TODO different torque control for different firmware
      for fw in car_fw:
      ...
      if candidate == CAR.RAV4_TSS2_2022:
        torque_params = CarInterfaceBase.get_torque_params(CAR.RAV4_TSS2)
      ...
      # TODO override until there is enough data
      if candidate == CAR.LEXUS_ESH:
        torque_params = CarInterfaceBase.get_torque_params(CAR.LEXUS_ES_TSS2)
      ...
      # TODO override until there is enough data
      if candidate == CAR.LEXUS_RC:
        torque_params = CarInterfaceBase.get_torque_params(CAR.LEXUS_IS)
      ...
      # TODO override until there is enough data
      torque_params = {'LAT_ACCEL_FACTOR': 2.5, 'FRICTION': 0.1}
      ...
      # TODO override until there is enough data
      if candidate == CAR.LEXUS_NXH:
        torque_params = CarInterfaceBase.get_torque_params(CAR.LEXUS_NX)
      elif candidate == CAR.LEXUS_NXH_TSS2:
        torque_params = CarInterfaceBase.get_torque_params(CAR.LEXUS_NX_TSS2)
      ...
      # TODO override until there is enough data
      torque_params = CarInterfaceBase.get_torque_params(CAR.SIENNA)
